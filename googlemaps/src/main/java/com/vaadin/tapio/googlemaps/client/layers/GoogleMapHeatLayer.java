...
public class GoogleMapHeatLayer implements Serializable {
     ...
     */
    public GoogleMapHeatLayer(String url) {
        this();
        this.url = url;
    }
     ...
     *            are clicked.
     */
    public GoogleMapHeatLayer(String url, boolean clickable,
     ...
     */
    public String getUrl(Point a, double zoom) {
        return url + "?colorScheme=" + "classic"
				+ "&zoom=" + zoom + "&x=" + a.getX() + "&y="
				+ a.getY();
    }
    ...
    public boolean equals(Object obj) {
        ...
        GoogleMapHeatLayer other = (GoogleMapHeatLayer) obj;
        if (id != other.id) {
            return false;
        }
        return true;
